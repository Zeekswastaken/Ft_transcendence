...
export default class Paddel implements Player{
    ...
    constructor(p5: P5CanvasInstance, isLeft: boolean) {
        ...
        this.gap = this.width / 2; //this.width / 2
        this.score = 0;
    ...
    updatePlayer(p5: P5CanvasInstance)
    {
    ...
    updateComputer(p5: P5CanvasInstance, ball: Ball, COM_LEVEL: number)
    {
        let targetPos = ball.y - this.height / 2;
        this.pos.y = lerp(this.pos.y ,targetPos, COM_LEVEL);
    }
}