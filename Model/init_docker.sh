...
# Config
docker_destination="/goinfre/$USER/docker" #=> Select dock
...
echo "${cyan}Docker${blue} is now starting! Please report any bug to: ${cyan}aguiot--${reset}"# Ensure USER variabe is set
[ -z "${USER}" ] && export USER=$(whoami)
